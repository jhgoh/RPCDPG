...
#            )
        ...
        #)        
        for x in process.customPhysicsSetup.parameterNames_():
            setattr(process.g4SimHits.Physics, x, getattr(process.customPhysicsSetup, x))
