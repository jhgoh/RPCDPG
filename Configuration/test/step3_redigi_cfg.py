...
# Automatic addition of the customisation function from RPCUpgrade.Configuration.customise_rpcRedigi_cff
from RPCUpgrade.Configuration.customise_rpcRedigi_cff import customise_rpcRedigi 
